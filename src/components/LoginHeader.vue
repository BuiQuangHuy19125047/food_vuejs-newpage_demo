<template>
    <div id="login-header">
        <div class="login-header__title">
            <svg width="32" height="18" viewBox="0 0 99.5 56.5" fill="#FF3008" class="brand-symbol">
            ...
            <div class="brand-name">
                <svg width="112" height="13" viewBox="0 0 361.1 42" fill="#FF3008">
...
#login-header .login-header__title{
    align-self: center;
    display: flex;
    height: 27px;
}
