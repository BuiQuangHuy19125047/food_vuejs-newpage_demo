    ...
    <div v-bind:class="classObject" class=" nav--max-height header__container">
      ...
      <!-- Begin nav-list -->
        <div v-bind:class="{'cotainer--max-height-scroll': isScroll}" class="nav--max-height nav">
          <ul class="nav--max-height nav__list">
            <li >
              <a href="#">
                Home
                <i class="nav__icon material-icons">expand_more</i>
              </a>
            ...
            <li>
              ...
              <ul class="nav__subnav">
                ...
                <li><a href="#">Team</a></li>
                <li class="nav__subnav--relative">
                  <a href="#">
                    Blog
                    <i class="nav__subnav-icon material-icons"> chevron_right </i>
                  </a>
                  <ul class="blog-subnav nav__subnav">
                    <li><a href="#">Blog</a></li>
        ...
        <div v-bind:class="{'cotainer--max-height-scroll': isScroll}" class="nav--max-height nav__order">
          ...
          <div class="nav__order-cart">
            <a href="#">
              <i class="cart-icon material-icons"> shopping_cart </i>
              <sup>0</sup>
            </a>
          </div>
          <div class="nav__order-sidebar">
            <a href="#">
              <i class="sidebar-icon material-icons"> apps </i>
            </a>
            <div class="sidebar-button">
              <router-link to="/login" class="sidebar-button__sign-in" exact>Sign in</router-link>
              <router-link to="/signup" class="sidebar-button__sign-up" exact>Sign up</router-link>
            </div>
          </div>
        </div>
      </div>
...
.nav__list > li:hover > .nav__subnav{
...
.nav__list li:hover .nav__subnav li:hover .blog-subnav{
  display: block;
  position: absolute;
  left: 100%;
  top: 0px;
...
.nav__list .nav__subnav .nav__subnav-icon{
  color: #000;
  font-size: 12px;
  font-weight: 700;
  margin-left: 160px;
...
#header .nav__order .nav__order-button a{
  background: #e7272d;
...
#header .nav__order .nav__order-button:hover a{
...
#header .nav__order .nav__order-cart i{
  color: #fff;
  font-size: 18px;
}

#header .nav__order .nav__order-cart sup{
  color: #fff;
  font-size: 10px;
  font-weight: 700;
  background-color: #e7272d;
...
#header .nav__order .nav__order-sidebar .sidebar-button{
  display: flex;
  background-color: #e7272d;
  font-size: 14px;
}

#header .nav__order .nav__order-sidebar .sidebar-button a{
  align-self: center;
  text-decoration: none;
  text-transform: uppercase;
}

.sidebar-button__sign-in{
  color: #fff;
  font-weight: 500;
  padding: 0 4px;
}

.sidebar-button__sign-in:hover{
  color: #ffc107;
}

.sidebar-button__sign-up{
  color: #fff;
  font-weight: 700;
  padding: 8px;
  margin-left: 4px;
